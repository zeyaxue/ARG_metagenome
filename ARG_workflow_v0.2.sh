...
# SET VARIABLE
mkdir $run_dir/pipeline_stats
stats_dir=$run_dir/pipeline_stats
...
$cal_libsize $unzip_outdir $stats_dir/step0_libsize.tsv fq
...
bmtagger_outdir=$run_dir/step_1_BMTagger_output
#
...
#
## Get the library size 
$cal_libsize $bmtagger_outdir $stats_dir/step1_libsize.tsv fq
...
#
## Get the library size 
$cal_libsize $trim_outdir $stats_dir/step2_libsize.tsv fq
...
#
## Get the library size 
$cal_libsize $dup_outdir $stats_dir/step3_libsize.tsv fq
...
#
## Get the library size 
$cal_libsize $flash_outdir $stats_dir/step4_libsize.tsv fq
