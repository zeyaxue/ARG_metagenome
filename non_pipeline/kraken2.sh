...
kraken2_location=/share/lemaylab-backedup/milklab/programs/kraken2-2.0.9b/kraken2_ver2
...
do
	...
	python $bracken_location/src/est_abundance.py -i $kraken2_outdir/${STEM}_report -k $db/database151mers.kmer_distrib -l S -t 10 -o $kraken2_outdir/${STEM}_species_abundance.tsv
...
python $bracken_location/analysis_scripts/combine_bracken_outputs_re.py --names $names --output $kraken2_outdir/merged_species_abundance.tsv --files $kraken2_outdir/*_species_abundance.tsv
